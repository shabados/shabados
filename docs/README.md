...
| [interaction.md](interaction.md) | **Layer 2** — how each platform delivers a requirement; icons live in `brand/icons.json` | Building any platform UI |
...
[interaction.md](interaction.md); icon mappings are **data** in `brand/icons.json`,
